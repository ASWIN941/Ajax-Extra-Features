...
API_ID = int(environ['17472409'])
API_HASH = environ['f88f6e75e24743472483687be021b684']
BOT_TOKEN = environ['5140121082:AAFiv0Sipv3MxcDEJFl3vH8ac2CfzAqLi14']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5377042833', '').split()]
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://Blabbering:Blabbering@cluster0.dexxtgz.mongodb.net/?retryWrites=true&w=majority
', "")
...
# Others
LOG_CHANNEL = int(environ.get('-1001684400036', 0))
